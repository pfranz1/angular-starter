class Pot {
  ...
  resize(mult) {
    this.height = Pot.tileHeight * mult;
    this.width = Pot.tileWidth * mult;
  ...
  doCollsionCheck(colliderPos, colliderSize) {
    let isWithinPotBounds =
      colliderPos.x >= this.startX && colliderPos.x < this.endX;
